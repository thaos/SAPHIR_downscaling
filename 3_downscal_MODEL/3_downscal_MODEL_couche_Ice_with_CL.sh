...
/usr/bin/Rscript  --vanilla 3_downscal_MODEL_ICEcloud_with_CL.R $1 $2 $3 $4> 3_downscal_MODEL_ICEcloud_with_CL_$1_$2_$3_$4.log 2>&1


# aa=Indian_Ocean; ay=2013; m=7; for l in {1,6}; do qsub 3_downscal_MODEL_couche_Ice_with_CL.sh -q infini -F"$aa $ay $m $l"; done
