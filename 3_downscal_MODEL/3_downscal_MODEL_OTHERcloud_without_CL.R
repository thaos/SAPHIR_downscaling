...
##Script MODEL = calcul du model qrf pour chaque couche d HR pour les nuages autre que glace, sans CloudSat
...
clustering_downscall<-function(area,year,month.num,layer)
{
  ...
  filename.dir.out <- paste0(output,"model_LIQ_cloud_sans_CloudSat/QRF_model_entire_timeseries/",year,"/")
